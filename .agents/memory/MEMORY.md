...
- [Delivery completion gating](delivery-confirmation-flow.md) — driver deliveries finalize only after customer confirms; markOrderDelivered enforces the driverUid + pending-confirmation invariant.
