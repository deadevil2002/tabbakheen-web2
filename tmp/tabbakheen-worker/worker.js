...
'.sidebar{width:240px;background:var(--sidebar);padding:20px 0;display:flex;flex-direction:column;position:fixed;top:0;bottom:0;z-index:100;visibility:hidden;transform:translateX(-100%)}\n' +
